...
import { X, Filter, Tag, Calendar, Activity, TrendingUp } from 'lucide-react';
...
const AdvancedFilters = ({ offers, onFilterChange, onClose }) => {
    ...
    useEffect(() => {
        applyFilters();
    }, [selectedTags, dateRange, adCountRange, performanceFilter]);
    ...
    const applyFilters = () => {
        ...
        if (dateRange.end) {
            ...
            filtered = filtered.filter(offer =>
                new Date(offer.created_at) <= endDate
            );
        }
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="text-xs text-slate-600 mb-1.5 block">Até (inclusive)</label>
                                <input
                                    type="date"
                                    value={dateRange.end}
